...
- Processus reproductible et scalable (l'architecture du workflow a été adaptée pour d'autres périmètres).
...
## 📁 Contenu du projet
- Etape 1 : Récupération et traitement automatique des extractions.
- Etape 2 : Actualisation, contrôle et envoi du reporting.
